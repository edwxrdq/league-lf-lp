...
export default function aboutPage() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            ...
            <div className="left-0 top-0 flex-full justify-left font-mono text-md lg:flex">
                <p className="fixed left-0 top-0 justify-left text-left border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-6 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
                    With intentions of creating a formidable, presentable project to showcase my coding knowledge (or lack thereof), my progress here was made possible through the support and encouragement of my co-creator/co-owner, Marjorie (ign: JaeZhou).
                    <br></br>
